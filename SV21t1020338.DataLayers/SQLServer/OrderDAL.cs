    ...
    public class OrderDAL : _BaseDAL, IOrderDAL
    {
        ...
        public int Count(int status = 0, DateTime? fromTime = null, DateTime? toTime = null, string searchValue = "")
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                count = connection.ExecuteScalar<int>(sql: sql, param: param, commandType: CommandType.Text);
        ...
        public bool Delete(int orderID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                int count = connection.Execute(sql,param: new { OrderID = orderID }, commandType: CommandType.Text);
                result = count > 0;
                connection.Close();
            }
            return result;
        ...
        public bool DeleteDetail(int orderID, int productID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                int count = connection.Execute(sql, param: param, commandType: CommandType.Text);
                result = count > 0;
                connection.Close();
            }
            return result;
        ...
        public Order? Get(int orderID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                data = connection.QueryFirstOrDefault<Order?>(sql, param : new { OrderID = orderID },commandType: CommandType.Text);
                connection.Close();
            }
            return data;
        }
        ...
        public OrderDetail? GetDetail(int orderID, int productID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                data = connection.QueryFirstOrDefault<OrderDetail>(sql, param: param, commandType: CommandType.Text);
                connection.Close();
            }
            return data;
        }
                                    ...
                                    string searchValue = "")
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                list = connection.Query<Order>(sql, param: param, commandType: CommandType.Text).ToList();
                connection.Close();
            }
            return list;
        }
        ...
        public IList<OrderDetail> ListDetails(int orderID)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                list = connection.Query<OrderDetail>(sql,param: new { OrderID = orderID } ,commandType: CommandType.Text).ToList();
                connection.Close() ;
            }
            return list;
        }
        ...
        public bool Update(Order data)
        {
            ...
            using (var connection = OpenConnection())
            {
                ...
                result = connection.Execute(sql,param: param, commandType:CommandType.Text) >0 ;
                connection.Close();
            }
            return result;
        }

        public bool UpdateDelivery(int orderId, string province, string address)
        {
            bool result = false;
            using (var connection = OpenConnection())
            {
