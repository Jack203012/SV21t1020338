...
namespace SV21t1020338.Web.AppCodes
{
    public static class SelectListHelper
    {
        ...
        public static List<SelectListItem> Provinces()
        {
            ...
            foreach (var item in CommonDataService.GetProvinceList())
            {
                list.Add(new SelectListItem()
                {
        ...
        public static List<SelectListItem> Customers()
        {
            ...
            int rowCount;
            foreach (var item in CommonDataService.GetCustomerList(out rowCount))
            {
                list.Add(new SelectListItem()
                {
